...
public class ByteStream
{
    ...
    ///<exception cref="IndexOutOfRangeException">Thrown when the number of bytes to read is greater than the number of bytes remaining in the buffer.</exception>
    internal byte ReadByte()
    {
        if (m_position >= m_buffer.Length) throw new IndexOutOfRangeException("End of stream reached.");
    ...
    {
        if (m_position + count > m_buffer.Length) throw new IndexOutOfRangeException("End of stream reached");
